...
var SchemeGroupVersion = schema.GroupVersion{Group: "tomlebreux.com", Version: "v1alpha1"}
...
var _ runtime.Object = (*ClusterRancherToken)(nil)

type ClusterRancherToken struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`
...
func (in *ClusterRancherToken) DeepCopyInto(out *ClusterRancherToken) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.Spec = in.Spec
...
func (in *ClusterRancherToken) DeepCopy() *ClusterRancherToken {
	if in == nil {
		return nil
	}
	out := new(ClusterRancherToken)
	in.DeepCopyInto(out)
	return out
}

func (r *ClusterRancherToken) DeepCopyObject() runtime.Object {
	if c := r.DeepCopy(); c != nil {
		return c
	}
	return nil
